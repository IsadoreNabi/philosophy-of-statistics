...
date: 2025-09-18
categories: [R, topología, series-temporales, Análisis Topológico de Datos, Análisis de Series Temporales, Imputación de Datos, Modelado Matemático, Análisis de Conectividad, Quiebres Estructurales, Segmentación de Series Temporales, Topología Computacional, Homología Persistente, Validación de Métodos, Reglas de Decisión, Econometría, Aplicaciones en Neurociencia, Ciencias del Clima, Procesamiento de Señales, Desarrollo de Algoritmos, Software, Garantía de Calidad de Datos, Gobernanza de Modelos, Estadística Matemática, Matemáticas Aplicadas, Imputación, Estadística, Matemática, Marx, Engels, GitHub]
format:
  html:
    toc: true
    code-copy: true
